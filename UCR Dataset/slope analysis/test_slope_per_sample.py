...
slope_40 = np.abs(recent_slope_before_cutoff(X_test_norm, 40, window=10))
slope_30 = np.abs(recent_slope_before_cutoff(X_test_norm, 30, window=10))
slope_50 = np.abs(recent_slope_before_cutoff(X_test_norm, 50, window=10))
